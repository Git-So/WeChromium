  ...
  plugins: [
    monkey({
      ...
      userscript: {
        ...
        updateURL: "https://github.com/Git-So/WeChromium/releases/latest/download/wechromium.user.js",
        downloadURL: "https://github.com/Git-So/WeChromium/releases/latest/download/wechromium.user.js",
